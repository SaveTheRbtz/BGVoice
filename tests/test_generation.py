...
def test_voice_design_dialogue_samples_are_stable_and_bounded(line_count: int) -> None:
    ...
    lines = [
        _line("A.DLG", 100, "Hmm."),
        _line("A.DLG", 101, "x" * generation_module.VOICE_DESIGN_SAMPLE_MIN_CHARS),
        *[_line("A.DLG", state, text) for state, text in enumerate(eligible)],
    ]
...
async def test_directions_continue_skip_persisted_and_clear_failures(
    ...
    try:
        ...
        invalid = _line("AERIE.DLG", 99, "x" * 2001)
